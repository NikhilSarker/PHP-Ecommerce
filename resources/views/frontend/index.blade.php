    ...
    <div class="container">
        ...
        <div class="featured-categorie-slider owl-carousel">
            ...
            <div class="featured-item ">
                <div class="images ">
                    <img style="width:80px; display:inline-block;" src="{{asset('uploads/category')}}/{{$category->category_image}}" alt="">
                </div>
                <div class="text">
                    <h2>
                        @if (Str::length($category->category_name) > 12)
                        <a title="{{$category->category_name}}" href="product.html">{{Str::substr($category->category_name,0,12).'...'}}</a>
                        @else
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="product-item">
                        <div class="image">
                            <img height="250px" src="{{asset('uploads/product/preview-image')}}/{{$product->preview_image}}" alt="">
                            @if ($product->discount)
                        ...
                        <div class="text">
                            <h2><a title="{{$product->product_name}}" href="product-single.html">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="highlight-wrap">
                    ...
                    <div class="product-card">
                        <div class="card-image">
                            <div class="image">
                                <img height="" src="{{asset('uploads/product/preview-image')}}/{{$product->preview_image}}" alt="">
                            </div>
                        </div>
                        <div class="content">
                            <h3>
